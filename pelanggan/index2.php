...
if($op == 'delete'){
    $id         = $_GET['id'];
    $sql1       = "delete from data_pelanggan where id = '$id'";
...
if ($op == 'edit') {
    $id         = $_GET['id'];
    $sql1       = "select * from data_pelanggan where id = '$id'";
    $q1         = mysqli_query($koneksi, $sql1);
...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nomor && $nama && $alamat && $jk) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update data_pelanggan set nomor = '$nomor',nama='$nama',alamat = '$alamat',jk='$jk' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into data_pelanggan(nomor,nama,alamat,jk) values ('$nomor','$nama','$alamat','$jk')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $sql2   = "select * from data_pelanggan order by id desc";
